...
module.exports = {
    ...
    cooldown: 3,
    description: {
        content: 'Hành động hoạt hình confused',
        example: 'confused @Yubabe bạn có thể nhập tên hoặc Id',
        usage: 'confused [@mention/username/userId]'
    },
    permission: {
        bot: [],
        user: []
            ...
            return message.channel.send({
                embeds: [
                    client.embed()
                        .setColor(client.color.y)
                        .setAuthor({
                            name: `${message.member.displayName} đang bị lú lẫn`,
            ...
            return message.channel.send({
                embeds: [
                    client.embed()
                        .setColor(client.color.y)
                        .setAuthor({
                            name: `${user.displayName} bảo ${user.displayName}, đang bị lú lẫn à`,
                            iconURL: message.member.displayAvatarURL({})
                        })
                        .setImage(await anime.confused())
                ]
